    ...
    <div className="relative flex flex-col min-h-[100dvh]">
      <header className="absolute top-0 w-full px-4 lg:px-6 h-14 flex items-center justify-between z-10">
        ...
        <div className="ml-auto flex items-center">
          <button
            className="menu-button lg:hidden flex items-center justify-center p-2 rounded-md text-white hover:text-gray-100 focus:outline-none"
          ...
          <nav
            className={`mobile-menu lg:flex gap-4 sm:gap-6 ${
              isMobileMenuOpen
                ? "absolute top-10 right-10 w-3/6 h-28 bg-[#1F2937] shadow-lg py-4 flex flex-col items-center justify-around rounded-md"
                : "hidden"
            } lg:block`}
          >
            <Link
      ...
      <main className="flex-1">
        ...
        <section className="relative top-0 w-full min-h-[70vh] md:min-h-screen pt-12 md:py-0 lg:py-32 xl:py-48 mt-[-50px] md:mt-[-680px]">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="flex flex-col items-center justify-center gap-2 min-[400px]:flex-row min-[400px]:justify-center">
                <Link
        ...
        <section
          id="services"
          className="w-full bg-gray-100 dark:bg-gray-800 py-10"
        >
            ...
            <div className="grid items-center justify-center gap-4 text-center">
              <div className="space-y-3">
                ...
                <p className="mx-auto max-w-[600px] text-gray-500 text-base sm:text-lg md:text-xl lg:text-xl dark:text-gray-400">
                  Fill out the form below to learn more about our AI consulting
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 Tekhliq Labs. All rights reserved.
        </p>
      </footer>
      <Script
